...
newGameValidation = function(name,howmanyoponents) {
  ...
  if(name == "" || howmanyoponents == "" || howmanyoponents < 2 || howmanyoponents > 4 || isNaN(howmanyoponents) ) {
      if(name == ""){
...
consoleNotLeavePenaltyBox = function(player) {
  $('#gameConsole').append(' <p class="item penalty">:( ... ' + player + ' is not getting out of the penalty box! </p>'); 
}
